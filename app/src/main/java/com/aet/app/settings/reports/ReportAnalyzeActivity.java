...
public class ReportAnalyzeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_analyse_activity);
    ...
    private void InitView() {
        ...
        txtMulai.setOnClickListener(v -> {
            ...
            // date picker dialog
            picker = new DatePickerDialog(ReportAnalyzeActivity.this,
    ...
    class GetReport extends AsyncTask<String, String, String> {
        ...
        private String URL_REPORT = Constants.BASE_URL + "api/report/analyze";
        private JSONParser jsonParser = new JSONParser();

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ReportAnalyzeActivity.this);
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(ReportAnalyzeActivity.this, "PDF sudah dibuat di folder Downloads", Toast.LENGTH_LONG).show();
        }
        ...
        protected String doInBackground(String... strings) {
            ...
            if (spinnerFilter.getSelectedItemPosition() == 0) {
                ...
                Log.d("report", json.toString());
                try {
                    AllWithDetails(json.toString(), "analyze_all");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                ...
                Log.d("report", json.toString());
                try {
                    All(json.toString(), "analyze_bydate");
                } catch (IOException e) {
                    e.printStackTrace();
                }
            } else {
                ...
                Log.d("report", json.toString());
                try {
                    AllWithDetails(json.toString(), "analyze_bydate");
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
    ...
    private void All(String json, String filename) throws IOException {
        ...
        document.add(new Paragraph("REKAP LATIHAN ANALYZE").setTextAlignment(TextAlignment.CENTER));
        ...
        try {
            ...
            if (status == 200) {
                ...
                for (int i = 0; i < arr.length(); i++) {
                    ...
                    tanggal.add(obData.optString("updated_at"));
                    nilai.add(obData.optString("nilai"));
                    JSONArray arrDetail = obData.getJSONArray("all_details");
                    ...
                    for (int j = 0; j < arrDetail.length(); j++) {
                        ...
                        jawaban.get(i).add(obDetail.optString("keterangan"));
